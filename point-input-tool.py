...
def convertToTups(listOfLineSets):
    tupSets=[]
...
class Application:
    def __init__(self):
        self.hasQuit=False
        #has
        self.graphGuides=[[[[0, 4], [0, 0]], [[0, 0], [2, 0]], [[2, 0], [2, 4]], [[2, 4], [0, 4]]]]
...
#output
print(appInstance.submittedLines)
if config.convertToTups:
    print(convertToTups(appInstance.submittedLines))
if config.convertToFontDict:
    print(convertToFontDict(appInstance.submittedLines))
